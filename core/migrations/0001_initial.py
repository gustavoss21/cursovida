    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('endereco', models.CharField(max_length=15, verbose_name='Endereço')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agenciador', models.CharField(default='', max_length=100, verbose_name='Agenciador')),
                ('bio', models.CharField(max_length=100, verbose_name='Bio')),
                ('usuario', models.ForeignKey(max_length=100, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Usuário')),
            ],
            options={
